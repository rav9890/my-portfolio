...
<div style="background:#232F3F;margin:auto;" class="row">
	<center>
	<div class="col-sm-2">
     <h3 id="heading">E - Auction</span></h3>
  ...
  <center>
	...
	<div class="col-sm-7">
		<ul class="menus">
			...
			<a href="history"><li><b style="color:white;">History</b></li></a>
            <a href="login"><li><b style="color:white;">Login</b></li></a>
            <a href="seller/"><li><b style="color:white;">Seller</b></li></a>
