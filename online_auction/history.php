...
.table-responsive {background-color: rgba(0 , 0, 0 , 0.6);padding:20px;color:white;height:500px;}
...
<body>
     ...
     <div class="container-fluid">
      ...
      <div class="table-responsive">
        ...
        <?php
        $select = mysqli_query($con,"SELECT * FROM tbl_boli1 WHERE user_id = '".$_SESSION['user_id']."' ");
        $counter = 1;
